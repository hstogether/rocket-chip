...
object Instructions {
  ...
  def FMV_F_H            = BitPat("b111011000000?????000?????1010011")
  ...
  def FMV_H_F            = BitPat("b111111000000?????000?????1010011")
  ...
  def PAL_H              = BitPat("b?????10??????????001?????0101011")
  def PAH_H              = BitPat("b?????10??????????010?????0101011")
  def LSE1_H             = BitPat("b0000010??????????101?????0101011")
  def LSE2_H             = BitPat("b0000010??????????110?????0101011")
  def LSE3_H             = BitPat("b0000010??????????011?????0101011")
  def LSA0_H             = BitPat("b0000010??????????????????0001011")
  def LSA1_H             = BitPat("b0000110??????????????????0001011")
  def LSA2_H             = BitPat("b0001010??????????????????0001011")
  def LSA3_H             = BitPat("b0001110??????????????????0001011")
  def PMAX_H             = BitPat("b111111000000?????001?????1010011")
  def PMIN_H             = BitPat("b111111000000?????010?????1010011")
  def PSUM_H             = BitPat("b111111000000?????011?????1010011")
  def PAVE_H             = BitPat("b111111000000?????100?????1010011")
  def RELU_H             = BitPat("b111111000000?????101?????1010011")
  def RS1_H              = BitPat("b111011000000?????001?????1010011")
  def RS2_H              = BitPat("b111011000000?????010?????1010011")
  def RS3_H              = BitPat("b111011000000?????011?????1010011")
  def FI0_H              = BitPat("b111011000000?????100?????1010011")
  def CR_H               = BitPat("b111011000000?????101?????1010011")
  def TR_H               = BitPat("b111011000000?????110?????1010011")
